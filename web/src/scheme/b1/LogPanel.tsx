...
export function LogPanel({ entries, locale }: LogPanelProps) {
	...
	return (
		<div className="fixed bottom-8 right-8 z-50 select-none" ref={panelRef}>
			{/* Expanded Panel */}
			{isOpen && (
				<div id="a-workflow-log-panel" className="absolute bottom-full right-0 mb-4 w-80 max-h-[480px] bg-zinc-950/95 backdrop-blur-2xl border border-zinc-800/80 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300 ease-out">

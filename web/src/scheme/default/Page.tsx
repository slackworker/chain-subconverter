...
const COPY = {
	zh: {
		...
		memberOrderMoveUp: "上移",
		memberOrderMoveDown: "下移",
		memberOrderMoveUpAria: "将 {name} 上移到第 {position} 位",
		memberOrderMoveDownAria: "将 {name} 下移到第 {position} 位",
	...
	en: {
		...
		memberOrderMoveUp: "Move up",
		memberOrderMoveDown: "Move down",
		memberOrderMoveUpAria: "Move {name} up to position {position}",
		memberOrderMoveDownAria: "Move {name} down to position {position}",

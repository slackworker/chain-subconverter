...
const COPY = {
	zh: {
		...
		generateLink: "生成链接",
		stage3Title: "输出",
		stage3Desc: "打开、复制、下载生成的订阅链接；输入已有链接或 short ID 进行反向解析",
		currentLink: "当前链接",
	...
	en: {
		...
		stage3Title: "Output",
		stage3Desc: "Open, copy, or download the generated subscription link, or paste an existing link or short ID to restore state.",

...
const COPY = {
	zh: {
		...
		conflictReadonly: "当前链接无法完整恢复阶段 2 及之后配置（阶段 1 若可解析已填回）。请重新执行「转换并自动填充」后再继续。",
		colLanding: "落地节点",
		colType: "协议",
		colTypeAgg: "类型/协议",
		colServer: "服务器",
		...
		memberOrderDefaultInstanceBadge: "默认实例",
		memberOrderDuplicateBadge: "副本",
	...
	en: {
		...
		conflictReadonly: "This link cannot fully restore Stage 2 and later (Stage 1 is filled back when still parseable). Run Convert and autofill again before continuing.",
		...
		memberOrderDefaultInstanceBadge: "Default",
		memberOrderDuplicateBadge: "Duplicate",

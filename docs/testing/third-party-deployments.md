...
## 历史 — 内网/公网一体化（2026-05-29，`beta-latest` 滚动构建第 3 轮）

vps-01 / vps-02 以 digest `sha256:1262e8a0a82a4cdd0a0ed5e5530ffdcc794bf4cfd02cb168cc674014f2149f5a`（`beta` @ `32d5cfb`；发版口径 **`v3.0.0-beta.3`**）完成内网与公网一体化回归，`deployed-smoke` 均为 **通过**。

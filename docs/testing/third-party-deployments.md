...
> **当前验证镜像**：`ghcr.io/slackworker/chain-subconverter:dev-latest`（digest `sha256:e63870c873de28bfbfa22b68cf0b5d806382fb76ad16347e672c04c7c8f77b9b`，`dev` @ `78a4477`）。正式里程碑见 [`v3.2.0-beta.3`](../../RELEASES.md#v320-beta3)。
...
## 内网一体化 — vps-01（2026-07-03）

- **镜像 tag**：`ghcr.io/slackworker/chain-subconverter:dev-latest`（digest `sha256:e63870c8…`，`dev` @ `78a4477`）；`subconverter:integration-chain-subconverter`
...
## 公网 HTTPS 一体化 — vps-02（2026-07-03）

- **镜像 tag**：与 vps-01 同 tag（`dev-latest`，`dev` @ `78a4477`）；`subconverter:integration-chain-subconverter` 同 vps-01
...
## 双 Docker 分离 — Koyeb + vps-02（2026-07-03）
...
- **镜像 tag**：Koyeb app `dev-latest`（`dev` @ `78a4477`）；subconverter `integration-chain-subconverter`

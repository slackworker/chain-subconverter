...
| 事件 | 更新 |
|------|------|
| 发版 / 镜像 tag | **步骤**见 [testing/runbook.md](testing/runbook.md)；文档落点：[RELEASES.md](../RELEASES.md)（正式 tag）；[STATUS.md](STATUS.md) 页眉/最近验证各一行；[third-party-deployments.md](testing/third-party-deployments.md) **覆盖**对应形态节 |

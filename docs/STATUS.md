...
| 项 | 说明 |
|----|------|
| 激进链式故障转移双方案 | 见 [proposals/2026-06-aggressive-chain-failover.md](proposals/2026-06-aggressive-chain-failover.md)；`wt-b`（方案二“落地副本打包成组”）已落地并完成契约对齐与基线回归，当前无新增阻断项；方案一保留为后续对照探索 |

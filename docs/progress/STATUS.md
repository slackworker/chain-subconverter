...
| **internal/review/testdata/3pass-ss2022-test-subscription/** | `internal/review` 的稳定自动化 fixture：输入、3-pass 输出、阶段 2 snapshot 与最终 YAML golden | 手动 Front-end Review 工作区 |

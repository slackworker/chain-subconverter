...
func TestLoadCase_DefaultExample(t *testing.T) {
	...
	if !hasStringValue(testCase.Stage1Input.AdvancedOptions.Config, "https://raw.githubusercontent.com/slackworker/Custom_OpenClash_Rules/refs/heads/main/cfg/Custom_Clash.ini") {

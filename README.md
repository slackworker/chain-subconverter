...
> [v3.3.0-beta.1](RELEASES.md#v330-beta1) 已发布（3.3 Beta 线；Stage 2 嵌套树 `servers→sources→instances`，长链 `statePayload v5`）。上一里程碑：[v3.2.0-beta.3](RELEASES.md#v320-beta3)。

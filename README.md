...
> [v3.3.0-beta.5](RELEASES.md#v330-beta5) 已发布（3.3 Beta 线；`resolve-url` 拉源失败仍还原 Stage1；浏览器 `/sub` 预览走默认 UA；Stage 2 嵌套树 + 长链 `v5`）。上一里程碑：[v3.3.0-beta.4](RELEASES.md#v330-beta4)。
